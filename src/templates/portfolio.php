...
<section class="portfolio" id="portfolio">
    ...
    <div class="blocsite">
        <div class="projet1" data-aos="fade-up" data-aos-duration="1500" data-aos-easing="ease-in-out" data-aos-offset="100">
            <h3>Zeremy</h3>
            <p>Projet de site web pour un monteur vidéo freelance, site vitrine mais également permettant la publication de vidéo par l’intermédiaire de youtube .</p>
            <span></span>
            <div>
                <img src="./assets/images/site-jerem.webp" alt="">
